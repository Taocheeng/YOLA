...
model = dict(
    ...
    sam3_head=dict(
        ...
        sam3_kwargs=dict(
            ...
            device='cuda'),
        prompt_label_file='/home/taocheng/YOLA_Project/data/darkface/labels.txt',
        prompt_template='detect {label} in low-light face image',
        num_classes=1),
    train_cfg=dict(),
    test_cfg=dict(
        score_thr=0.01,
...
# 占位符：按你的实际 DarkFace 数据路径替换
# e.g. /home/taocheng/YOLA_Project/data/DarkFace/
dataset_type = 'DarkFaceDataset'
data_root = '/home/taocheng/YOLA_Project/data/darkface/'
backend_args = None
